...
# create metadata table
function create_metadatatbl(filekey::FileKey, part::DataPartitionLike)
    Table(Setup = [filekey.setup], Partition = [part], Category = [filekey.category])
end
...
const psd_part_log_text = """ ## PSD CUT
