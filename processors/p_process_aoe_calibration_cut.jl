        ...
        @showprogress desc="Detector: $det" for aoe_type in aoe_types
            ...
            try
                ...
                p = LegendMakie.lhist(h_aoe_uncal, figsize = (670,400), rasterize = true,
                    title = get_plottitle(filekey_ch, part, det, "AoE uncalibrated"; additiional_type=string(aoe_type)),
                ...
                if aoe_config_ch.use_combined_fit
                    ...
                    # create plots
                    p_μ = LegendMakie.lplot(report_fit_single.report_μ, report_fit_combined.report_µ, legend_position = :lb, watermark = true, figsize = (600,420), title = get_plottitle(filekey_ch, part, det, "A/E μ"; additiional_type=string(aoe_type)))
                    p_σ = LegendMakie.lplot(report_fit_single.report_σ, report_fit_combined.report_σ, legend_position = :lb, watermark = true, figsize = (600,420), title = get_plottitle(filekey_ch, part, det, "A/E σ"; additiional_type=string(aoe_type)))
                    ...
                    # create plots
                    p_μ = LegendMakie.lplot(report_fit_single.report_μ, legend_position = :lb, watermark = true, figsize = (600,420), title = get_plottitle(filekey_ch, part, det, "A/E µ"; additiional_type=string(aoe_type)))
                    p_σ = LegendMakie.lplot(report_fit_single.report_σ, legend_position = :lb, watermark = true, figsize = (600,420), title = get_plottitle(filekey_ch, part, det, "A/E σ"; additiional_type=string(aoe_type)))
