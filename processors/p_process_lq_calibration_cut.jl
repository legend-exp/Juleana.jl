function p_process_lq_calibration_cut(processing_config::PropDict, l200::LegendData, period::DataPeriod,; reprocess::Bool=false, timeout::Int=0, only_first_period::Bool=true)
    ...
    log_nt_cut = NamedTuple{(:Channel, :Detector, :Partition, :Status, Symbol("Classifier Type"), Symbol("Cut Value"), Symbol("DEP SF"), Symbol("CC SF"), :CutError)}
    ...
    function ch_lq_cut(chinfo_ch::NamedTuple)
        ...
        @showprogress desc="Detector: $det" for lq_type in lq_types
            ...
            try
                ...
                savelfig(LegendMakie.lsavefig, p, l200, part, filekey_ch, det, Symbol("lq_drift_time_vs_lq_plot_DEP_$lq_type"))

                p = LegendMakie.lplot(drift_report, e_cal, dt_eff, lq_e_corr, :whole, title = "Drift Time vs LQ for Detector: $det", figsize = (620,400))
                savelfig(LegendMakie.lsavefig, p, l200, part, filekey_ch, det, Symbol("lq_drift_time_vs_lq_plot_$lq_type"))
        ...
        @showprogress desc="Detector: $det" for lq_classifier in lq_classifiers
            ...
            try
                ...
                p = LegendMakie.lplot(report.fit_report, xlabel = Makie.rich("LQ", Makie.subscript(" ctc")), digits = 3, figsize = (600,450), 
                    legend_position = :none, title = get_plottitle(filekey_ch, part, det, "LQ DEP fit", additional_type=string(lq_classifier)))
                ...
                savelfig(LegendMakie.lsavefig, p, l200, part, filekey_ch, det, Symbol("lq_dep_fit_$lq_classifier"))
                ...
                savelfig(LegendMakie.lsavefig, p, l200, part, filekey_ch, det, Symbol("lq_sidebands_$lq_classifier"))
                ...
                savelfig(LegendMakie.lsavefig, p, l200, part, filekey_ch, det, Symbol("lq_sideband_window_$lq_classifier"))
                ...
                savelfig(LegendMakie.lsavefig, p, l200, part, filekey_ch, det, Symbol("lq_energy_vs_lq_norm_$lq_classifier"))
                ...
                savelfig(LegendMakie.lsavefig, p, l200, part, filekey_ch, det, Symbol("lq_energy_histogram_$lq_classifier"))
