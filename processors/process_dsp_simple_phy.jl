function process_dsp_simple_phy(processing_config::PropDict, l200::LegendData, period::DataPeriod, run::DataRun,; reprocess::Bool = false, timeout::Int=0, max_wvfs::Int=10000, use_partition_filter::Bool=false)
                ...
                @timeit dsp_timer "DSP" begin
                    ...
                    @showprogress desc="Filekey HPGe: $fk" output=stdout for chinfo_ch in chinfo
                        ...
                        @timeit dsp_timer "DSP $det" begin
                            ...
                            outdata_ch = nothing
                            try
                                outdata_ch = dsp_ged_auto(raw_data[ch].raw[:], dsp_config_ch, dsp_config_pd.default_tau[det].tau)
                            catch e
                                if e isa TaskFailedException
                                    e = e.task.exception
                                end
